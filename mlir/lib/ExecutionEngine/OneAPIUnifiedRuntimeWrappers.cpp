//===- OneAPIUnifiedRuntimeWrappers.cpp - MLIR oneAPI unified runtime
//     wrapper library -------------------------------------------------- -===//
//
...
//===----------------------------------------------------------------------===//
//
// Implements wrappers around the oneAPI unified runtime library
//
//===----------------------------------------------------------------------===//
...
#ifdef _WIN32
#define ONEAPI_UNIFIED_RUNTIME_EXPORT __declspec(dllexport)
#else
#define ONEAPI_UNIFIED_RUNTIME_EXPORT
#endif // _WIN32
