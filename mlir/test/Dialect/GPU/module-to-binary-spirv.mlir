// RUN: mlir-opt %s --gpu-module-to-binary="format=assembly" | FileCheck %s

module attributes {gpu.container_module} {
  // CHECK-LABEL:gpu.binary @kernel_module
  // CHECK:[#gpu.object<#spirv.target, assembly = "{{.*}}">]
  gpu.module @kernel_module [#spirv.target<addressing = "Physical64", memory = "OpenCL">] {
