...
// RUN: mlir-opt %s --spir-attach-target='module=spir.* chip=XeHPC ver=v1.0 caps=Kernel' | FileCheck %s --check-prefix=CHECK_SPIR
...
// Verify the target is appended.
// CHECK_SPIR: @spir_module_1 [#spir.target<chip = "XeHPC", vce = #spirv.vce<v1.0, [Kernel], []>>] {
gpu.module @spir_module_1 {
}
// Verify the target is appended.
// CHECK_SPIR: @spir_module_2 [#spir.target<chip = "XeLPG">, #spir.target<chip = "XeHPC", vce = #spirv.vce<v1.0, [Kernel], []>>] {
gpu.module @spir_module_2 [#spir.target<chip = "XeLPG">] {
}
