// RUN: mlir-opt -split-input-file -convert-gpu-to-vc %s -o - | FileCheck %s --check-prefix=INDEX32
// RUN: mlir-opt -split-input-file -convert-gpu-to-vc %s -o - | FileCheck %s --check-prefix=INDEX64
