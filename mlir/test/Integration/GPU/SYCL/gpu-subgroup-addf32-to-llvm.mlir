// RUN: mlir-opt %s -pass-pipeline='builtin.module(spir64-attach-target{module=test.* chip=XeHPC ver=v1.0 caps=Kernel},gpu.module(map-memref-spirv-storage-class{client-api=opencl},convert-gpu-to-vc),func.func(llvm-request-c-wrappers),convert-scf-to-cf,convert-cf-to-llvm,convert-arith-to-llvm,convert-math-to-llvm,convert-func-to-llvm,gpu-to-llvm{use-bare-pointers-for-kernels=true},gpu-module-to-binary{format=bin},expand-strided-metadata,lower-affine,finalize-memref-to-llvm,reconcile-unrealized-casts)' \
// RUN: | mlir-cpu-runner \
...
module @add attributes {gpu.container_module} {
  ...
  gpu.module @test_kernel {
    gpu.func @test_kernel(%arg0: memref<2x4x4xf32>, %arg1: memref<2x4x4xf32>, %arg2: memref<2x4x4xf32>) kernel attributes {gpu.known_block_size = array<i32: 4, 4, 1>, gpu.known_grid_size = array<i32: 2, 1, 1>} {
      %c4 = arith.constant 4 : index
      %0 = gpu.block_id  x
