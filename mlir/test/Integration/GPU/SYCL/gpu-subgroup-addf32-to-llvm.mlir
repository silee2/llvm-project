...
module @add attributes {gpu.container_module} {
  ...
  func.func @test(%arg0: memref<2x4x4xf32>, %arg1: memref<2x4x4xf32>) -> memref<2x4x4xf32> {
    ...
    gpu.launch_func @test_kernel::@test_kernel blocks in (%c2, %c1, %c1) threads in (%c4, %c4, %c1) args(%memref_0 : memref<2x4x4xf32>, %mem : memref<2x4x4xf32>, %memref_2 : memref<2x4x4xf32>)
    %alloc = memref.alloc() : memref<2x4x4xf32>
    memref.copy %memref_2, %alloc : memref<2x4x4xf32> to memref<2x4x4xf32>
    gpu.dealloc %memref_2 : memref<2x4x4xf32>
    gpu.dealloc %memref_0 : memref<2x4x4xf32>
    gpu.dealloc %mem : memref<2x4x4xf32>
